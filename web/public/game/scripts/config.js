...
const CONFIG = {
  ...
  powerUps: {
    ...
    icefreezer: {
      ...
      outlineColor: '#01579b',
      emoji: '🧊',
      duration: 2000, // Complete freeze duration
      freezeDurationMs: 2000, // How long horse is completely frozen
      slowdownFactor: 0.7, // Speed multiplier after freeze ends (not used if completely frozen)
      glowColor: '#b3e5fc',
      glowAlpha: 0.9
    },
  testpower: {
...
// Add to scripts/config.js powerUps section:
nebula: {
  radius: 16,
  color: '#4A0E4E',
  outlineColor: 'rgba(255,255,255,0.5)',
...
nebula: { name: 'nebula', icon: '🔹', hotkey: 'N' }
  },
  ...
  editor: {
    tools: {
      ...
      timeFreeze: { name: 'timeFreeze', icon: '⏸️', hotkey: '5' },
      icefreezer: { name: 'icefreezer', icon: '🧊', hotkey: 'I' },
      ghost: { name: 'ghost', icon: '👻', hotkey: '6' },
      ram: { name: 'ram', icon: '💥', hotkey: '7' },
      shield: { name: 'shield', icon: '🛡️', hotkey: '8' },
      warpzone: { name: 'warpzone', icon: '❇️', hotkey: '0' },
