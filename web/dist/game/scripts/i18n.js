...
const translations = {
  ...
  vi: {
    ...
    horse_skill_oguri: 'Oguri Béo',
    horse_skill_silence: 'Im Lặng Shizuka',
    horse_skill_fireball: 'Cầu Lửa',
    horse_skill_energy: 'Cầu Năng Lượng',
    horse_skill_supersonic: 'Tốc Độ Siêu Thanh',
    horse_skill_meteor: 'Thiên Thạch',
    horse_skill_blackhole: 'Hố Đen',
    horse_skill_iceage: 'Kỷ Băng Hà',
    horse_skill_mirror: 'Ảnh Phản Chiếu',
    horse_skill_timewarp: 'Xoắn Thời Gian',
    horse_skill_blink: 'Dịch Chuyển',
    horse_skill_rocket: 'Tên Lửa Đẩy',
    horse_skill_gravityflip: 'Đảo Trọng Lực',
    horse_skill_phoenix: 'Phượng Hoàng Tái Sinh',
    horse_skill_avatar: 'Trạng Thái Avatar',
    horse_skill_rainbow: 'Vệt Cầu Vồng',
    horse_skill_disco: 'Hỗn Loạn Disco',
    horse_skill_aurora: 'Khiên Cực Quang',
