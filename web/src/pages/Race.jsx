...
const skillDescriptions = {
  ...
  guardian: "🛡️ Khiên vĩnh viễn chặn 1 hiệu ứng tiêu cực. Kích hoạt ngay. CD: 60s",
  ...
  energy_ball: "⚡ Phóng cầu năng lượng gây 20 HP + stun 1s. CD: 25s",
  supersonic_speed: "💨 +100% tốc độ 3s, xuyên qua ngựa. CD: 30s",
  meteor_strike: "☄️ Triệu hồi 3-5 thiên thạch, gây 15 HP + stun 1s. CD: 45s",
  black_hole: "🕳️ Tạo hố đen hút ngựa (bán kính 200) trong 3s. CD: 50s",
  ice_age: "❄️ Đóng băng vùng, slow 70% + trượt không kiểm soát 4s. CD: 55s",
  mirror_image: "🪞 Tạo 2 bản sao ảo, mỗi bản hấp thụ 1 skill. CD: 40s",
  time_warp: "⏰ Quay ngược 8s - trở về vị trí và HP cũ. CD: 60s",
  blink: "✨ Dịch chuyển tức thì 150px về phía trước. CD: 15s",
  rocket_boost: "🚀 Phóng tốc độ cực đại, đẩy ngựa khác sang 2 bên 1.5s. CD: 35s",
  gravity_flip: "🔄 Đảo trọng lực 3s - bay lên trần rồi rơi xuống. CD: 40s",
  phoenix_rebirth: "🔥 THỤ ĐỘNG: Khi HP=0, hồi sinh 50% HP + bất tử 3s (1 lần/race)",
  avatar_state: "🌀 x3 tốc độ + x2 damage + miễn slow 6s. CD: 120s",
  rainbow_trail: "🌈 +30% speed, để lại vệt cầu vồng +15% cho ngựa đi sau 5s. CD: 45s",
  disco_chaos: "🪩 Ngựa trong bán kính bị random direction mỗi 0.5s trong 4s. CD: 50s",
  aurora_shield: "✨ Shield hấp thụ 30 HP + reflect 50% damage 6s. CD: 55s"
}
