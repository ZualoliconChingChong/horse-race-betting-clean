...
(function() {
  ...
  const dictionary = {
    ...
    'Oguri Fat': 'Oguri Béo',
    'Silence Shizuka': 'Im Lặng Shizuka',
    'Fireball': 'Cầu Lửa',
    'Energy Ball': 'Cầu Năng Lượng',
    'Supersonic Speed': 'Tốc Độ Siêu Thanh',
    'Meteor Strike': 'Thiên Thạch',
    'Black Hole': 'Hố Đen',
    'Ice Age': 'Kỷ Băng Hà',
    'Mirror Image': 'Ảnh Phản Chiếu',
    'Time Warp': 'Xoắn Thời Gian',
    'Blink': 'Dịch Chuyển',
    'Rocket Boost': 'Tên Lửa Đẩy',
    'Gravity Flip': 'Đảo Trọng Lực',
    'Phoenix Rebirth': 'Phượng Hoàng Tái Sinh',
    'Avatar State': 'Trạng Thái Avatar',
    'Rainbow Trail': 'Vệt Cầu Vồng',
    'Disco Chaos': 'Hỗn Loạn Disco',
    'Aurora Shield': 'Khiên Cực Quang',
    'Body Color': 'Màu Thân',
